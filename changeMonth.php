...
<section>
	...
	<p> Only Mondays, Tuesdays and Saturdays should be selected</p>
	</figure>
...
<?php 	 
	try {
        ...
        $query = "SELECT dates as 'You are available on the following dates:' FROM available WHERE mbrID = '$mbrID' ";
